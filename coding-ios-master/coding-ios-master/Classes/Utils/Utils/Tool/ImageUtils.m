...
/**
 ...
 @return 二维码
 */
+ (UIImage *)createNormalQrWithData:(NSString *)data
    ...
    return [self createUIImageFromCIImage:outputImage size:imageWidth];
}
...
/**
 ...
 @return 二维码
 */
+ (UIImage *)createLogoQrWithData:(NSString *)data
    ...
    // 再把小图片画上去
    NSString *icon_imageName = logoImage;
...
/**
 ...
 @return 二维码
 */
+ (UIImage *)createColorQrWithData:(NSString *)data
                           bgColor:(CIColor *)bgColor
    ...
    // 6、需要使用 CIColor
    [color_filter setValue:bgColor forKey:@"inputColor0"];
...
/**
 ...
 @return 生成的UIImage
 */
+ (UIImage *)createUIImageFromCIImage:(CIImage *)image
                                 size:(CGFloat)size {
