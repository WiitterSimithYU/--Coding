...
//                          @"thumbnailData":msg.thumbnail ? [self dataWithImage:msg.thumbnail  scale:CGSizeMake(100, 100)] : [self dataWithImage:msg.image  scale:CGSizeMake(100, 100)],
//                          @"title": msg.title,
//                          @"webpageUrl":msg.link
//                          }
//                  
//                  };
        message=@{
                  @"__class" : @"WBMessageObject",
                  @"imageObject":@{
                          @"imageData":msg.thumbnail ? [self dataWithImage:msg.thumbnail] : [self dataWithImage:msg.image]
                          },
                  @"text" : [NSString stringWithFormat:@"%@ %@ %@",msg.title,msg.link,msg.desc ? msg.desc : @""]
                  };
    }
